...
export function itemLineTypeFromJSON(object: any): ItemLineType {
  switch (object) {
    ...
    case 6:
    case "DEAL_LINE_ITEM":
      return ItemLineType.DEAL_LINE_ITEM;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function itemLineTypeToJSON(object: ItemLineType): string {
  switch (object) {
    ...
    case ItemLineType.DEAL_LINE_ITEM:
      return "DEAL_LINE_ITEM";
