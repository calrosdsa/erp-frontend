...
export default function CountrySelect({
  ...
  // setCountry:(e:CountrySelectItem | null)=>void
  label: string;
  form: any;
}) {
  return (
          ...
          <Select onValueChange={(e)=>{
            ...
            <SelectContent>
              {countries.map((option, idx) => {
                return (
                  <SelectItem value={JSON.stringify(option)} key={idx}>
                    <div className="p-1 mr-2 flex space-x-2 w-full">
                    <img
                      loading="lazy"
                      width="20"
...
const countries: CountrySelectItem[] = [
